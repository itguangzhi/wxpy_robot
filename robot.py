...
def group_msg(msg):
    ...
    # 监听好友群聊，如老板讲话
    if msg.bot.is_listen_friend and msg.chat in msg.bot.listen_friend_groups \
            and msg.member.is_friend in msg.bot.listen_friends:
        msg.forward(msg.bot.master, prefix='监听好友群消息：「{0}」在「{1}」发了消息：'.format(
